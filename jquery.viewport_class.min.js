 ...
 */(function(e,t){"use strict";function n(){return e(window).width()}function r(){return e(window).height()}e.fn.viewportClass=function(t){function u(o,u){r.removeClass("viewport-"+i);if(i!==o){i=o;s=n()}r.addClass("viewport-"+o);t&&t(e.fn.viewportClass.viewportWidth,o,u)}var r=e(this);if(r.length===0)return;var i,s,o;i?o=!1:e(window).load(function(){var t=e.fn.viewportClass.getViewport();u(t,0)});e(window).bind("resize",function(){var t=e.fn.viewportClass.getViewport();t!==i&&u(t,n()>s?1:-1)});return this};e.fn.viewportClass.getViewport=function(){var t={width:n(),height:r()};if(t.width<320)t.viewport="mobile-mini";else if(t.width>=320&&t.width<480){t.viewport="mobile-portrait";t.viewportWidth=320}else if(t.width>=480&&t.width<767){t.viewport="mobile-landscape";t.viewportWidth=480}else if(t.width>=768&&t.width<959){t.viewport="tablet-portrait";t.viewportWidth=768}else if(t.width>=960){t.viewport="desktop";t.viewportWidth=960}for(var i in t)e.fn.viewportClass[i]=t[i];return t.viewport};e.fn.viewportClass.version=function(){return"0.1.1"}})(jQuery);