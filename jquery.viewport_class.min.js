 ...
 */(function(e,t){"use strict";function n(){return e(window).width()}function r(){return e(window).height()}e.fn.viewportClass=function(t,r){function a(r,u){i.removeClass("viewport-"+s);if(s!==r){s=r;o=n()}i.addClass("viewport-"+r);t&&t(e.fn.viewportClass.viewportWidth,r,u)}var i=e(this);if(i.length===0)return;typeof r=="undefined"&&(r={"mobile-mini":0,"mobile-portrait":320,"mobile-landscape":480,tablet_portrait:768,desktop:960});var s,o,u;s?u=!1:e(window).load(function(){var t=e.fn.viewportClass.getViewport(r);a(t,0)});e(window).bind("resize",function(){var t=e.fn.viewportClass.getViewport(r);t!==s&&a(t,n()>o?1:-1)});return this};e.fn.viewportClass.getViewport=function(t){var i={width:n(),height:r()},s=null;for(var o in t){if(i.width<=t[o]){i.viewport=o;i.viewportWidth=t[o];break}i.viewport=o;i.viewportWidth=t[o]}for(var o in i)e.fn.viewportClass[o]=i[o];return i.viewport};e.fn.viewportClass.version=function(){return"0.1.6"}})(jQuery);